...
**Important**: If there is no significant activity to report in the past 7 days (no commits, issues, PRs, or comments), use the `noop` tool to report "No significant activity in the past 7 days - skipping report generation."
