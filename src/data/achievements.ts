...
export const ACHIEVEMENTS: readonly AchievementDefinition[] = [
  ...
  {
    id: "tideglassCharterComplete",
    name: "Charter Captain",
    description: "Reopen the Tideglass route and acquire your first boat.",
    category: "exploration",
    points: 20,
    criteria: { type: "questCompleted", questId: "tideglassCharter" },
    source: {
      kind: "quest",
      authoritativeState: "Quest completion and replayable boat action",
      targetIds: ["tideglassCharter", "reedSkiff"],
    },
  },
  {
    id: "deepwakeKrakenDefeated",
    name: "Still the Deep",
    description: "Defeat the Deepwake Kraken without changing the campaign ending.",
    category: "combat",
    points: 35,
    criteria: { type: "bossDefeated", bossId: "kraken" },
    source: {
      kind: "boss",
      authoritativeState: "Defeated boss set",
      targetIds: ["kraken"],
    },
  },
  {
