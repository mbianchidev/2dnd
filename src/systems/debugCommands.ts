...
import { awardXP, processPendingLevelUps, xpForLevel } from "./player";
...
import type { HelpEntry } from "./debug";
...
export class DebugCommandSystem {
  ...
  constructor(scene: Phaser.Scene, player: PlayerState, callbacks: DebugCallbacks) {
    this.scene = scene;
    this.player = player;
